...
public class HexFeaturesManager : MonoBehaviour
{
    ...
    void AddWallSegment (
        Vector3 nearLeft, Vector3 farLeft, Vector3 nearRight,
        Vector3 farRight, bool addTower = false)
    {
    ...
    public void AddBridge (Vector3 roadCenter1, Vector3 roadCenter2)
    {
        ...
        instance.localScale = new Vector3(
            1f, 1f, length * (1f / HexMetrics.bridgeDesignLenght));
        instance.SetParent(container, false);
    }
