...
public class HexGridChunk : MonoBehaviour
{
    ...
    public HexFeaturesManager features;
    Canvas gridCanvas;
        ...
        )
    {
        ...
        {
            terrain.AddTriangleUnperturbed(HexMetrics.Perturb(left),
                HexMetrics.Perturb(right), boundary);
        ...
        )
    {
        ...
        terrain.AddQuadCellData(indices, w3, w4, weights2, weights2);
    }
